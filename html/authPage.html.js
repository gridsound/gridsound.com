	...
	GSUcreateDiv( { class: "page", id: "authPage" },
		GSUcreateElement( "form", { class: "form", id: "authPageSignup" },
			...
			GSUcreateDiv( { class: "form-btns" },
				GSUcreateButton( { class: "btn btn-submit", id: "authPageSignupBtn", type: "submit" },
					GSUcreateSpan( { class: "btn-text" }, "Sign up" ),
				),
			),
		),
		GSUcreateElement( "form", { class: "form", id: "authPageLogin" },
			...
			GSUcreateDiv( { class: "form-btns" },
				GSUcreateButton( { class: "btn btn-submit", id: "authPageLoginBtn", type: "submit" },
					GSUcreateSpan( { class: "btn-text" }, "Log in" ),
				),
			),
		),
	),
